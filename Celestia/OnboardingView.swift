...
//  MusicJam
//
//  MUSICIAN ONBOARDING - Find Your Sound, Find Your Band
//
...
struct OnboardingView: View {
    ...
    let availableInterests = [
        ...
        "Folk", "Classical", "Hip-Hop", "R&B", "Electronic",
        "Metal", "Punk", "Indie", "Soul", "Funk"
    ]
    ...
    private var stepTitle: String {
        ...
        case 4: return "Music & Languages"
        case 5: return "Better Jam Matches"
    ...
    private var stepSubtitle: String {
        ...
        case 1: return "Share your musical story"
        case 2: return "Show yourself & your gear"
        case 3: return "Who you want to jam with"
        case 4: return "Your music style"
    ...
    private var step3View: some View {
        ScrollView(showsIndicators: false) {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 8) {
                    Text("Show Your Musical Side")
                        .font(.title)
                        .fontWeight(.bold)

                    Text("Great photos get 10x more jam requests")
                        .font(.subheadline)
                        .foregroundColor(.secondary)
                        .multilineTextAlignment(.center)
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        photoTipRow(icon: "guitars.fill", text: "Show yourself with your instrument!", color: .orange)
                        photoTipRow(icon: "music.mic", text: "Performance shots grab attention", color: .purple)
                        photoTipRow(icon: "person.3.fill", text: "Band photos show you're a team player", color: .blue)
    ...
    private var step4View: some View {
        ScrollView(showsIndicators: false) {
            VStack(spacing: 30) {
                ...
                VStack(spacing: 8) {
                    Text("Collaboration Preferences")
                        .font(.title)
                        .fontWeight(.bold)
                ...
                VStack(alignment: .leading, spacing: 12) {
                    Text("Open to collaborating with")
                        .font(.subheadline)
                        .fontWeight(.medium)
                        .foregroundColor(.secondary)
        ...
        ScrollView(showsIndicators: false) {
            VStack(spacing: 30) {
                ...
                VStack(spacing: 8) {
                    ...
                    Text("Add your genres and languages")
                        .font(.subheadline)
                        .foregroundColor(.secondary)
                }
