...
struct User: Identifiable, Codable, Equatable {
    ...
    // Advanced Profile Fields (kept for compatibility)
    var educationLevel: String?
    var height: Int? // in cm
    var religion: String?
    var relationshipGoal: String? // Legacy - use musicianGoal instead
    var smoking: String?
    var drinking: String?
    var pets: String?
    var exercise: String?
    ...
    // MARK: - Musician-Specific Fields

    // Instruments I play (with skill levels)
    var instruments: [String] = [] // Array of Instrument raw values
    var instrumentSkills: [[String: Any]] = [] // [{instrument: "guitar", yearsPlayed: 5, skillLevel: "advanced"}]

    // Genres I play
    var genres: [String] = [] // Array of MusicGenre raw values

    // Experience level
    var experienceLevel: String? // ExperienceLevel raw value
    var yearsPlaying: Int?

    // Commitment level
    var commitmentLevel: String? // CommitmentLevel raw value

    // Musician goal
    var musicianGoal: String? // MusicianGoal raw value

    // Equipment & Space
    var hasOwnEquipment: Bool = false
    var equipmentOwned: [String] = [] // List of equipment
    var hasPracticeSpace: Bool = false
    var practiceSpaceDescription: String?

    // Audio/Video samples
    var musicLinks: [[String: String]] = [] // [{type: "soundcloud", url: "..."}]

    // Musical influences
    var musicalInfluences: [String] = [] // Favorite artists

    // Band history
    var bandHistory: String?

    // Looking for specific instruments/roles
    var lookingForInstruments: [String] = []
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case instruments, instrumentSkills, genres
        case experienceLevel, yearsPlaying, commitmentLevel, musicianGoal
        case hasOwnEquipment, equipmentOwned, hasPracticeSpace, practiceSpaceDescription
        case musicLinks, musicalInfluences, bandHistory, lookingForInstruments
        case prompts
