...
//  Helps users create high-quality profiles that get more connections
//
    ...
    func calculateScore(for metrics: ProfileMetrics) -> (score: Int, tips: [ProfileQualityTip]) {
        ...
        if metrics.hasAge {
            ...
            tips.append(ProfileQualityTip(
                category: .completeness,
                title: "Add Your Age",
                message: "Required to help find age-appropriate collaborators",
                impact: .critical,
                isCompleted: false,
                points: 5,
                actionIcon: "calendar"
        ...
        if metrics.hasLocation {
            ...
            tips.append(ProfileQualityTip(
                ...
                message: "Help us find musicians near you",
                impact: .high,
                isCompleted: false,
                points: 10,
        ...
        if metrics.hasInterests {
            if metrics.interestCount >= 5 {
                ...
                tips.append(ProfileQualityTip(
                    ...
                    message: "5+ interests help find better collaborators",
                    impact: .medium,
                    isCompleted: false,
                    points: 5,
            ...
            tips.append(ProfileQualityTip(
                category: .interests,
                title: "Add Interests",
                message: "Share your hobbies to find like-minded musicians",
                impact: .medium,
                isCompleted: false,
                points: 15,
                actionIcon: "sparkles"
        ...
        if metrics.hasLanguages {
            ...
            tips.append(ProfileQualityTip(
                category: .completeness,
                title: "Add Languages",
                message: "Connect with musicians who speak your language",
                impact: .low,
                isCompleted: false,
                points: 5,
                actionIcon: "globe"
