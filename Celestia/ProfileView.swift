...
struct ProfileView: View {
                ...
                HStack {
                    ...
                    if let userId = user.id,
                       ...
                       shareURL.scheme == "https" {
                        ...
                        .accessibilityHint("Share your MusicJam profile with others")
                    }
    ...
    private func detailsCard(user: User) -> some View {
        VStack(spacing: 16) {
            ...
            Divider()
            detailRow(icon: "music.note.list", label: "Jam Goals", value: user.lookingFor)
            ...
            // Musician goal
            if let goal = user.musicianGoal, !goal.isEmpty {
                Divider()
                detailRow(icon: "guitars.fill", label: "Musician Goal", value: goal)
            }
    ...
    private var actionButtons: some View {
        VStack(spacing: 12) {
            ...
            actionButton(
                ...
                title: "Sign Out",
                color: .red,
                accessibilityHint: "Sign out of your MusicJam account"
            ) {
