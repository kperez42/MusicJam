...
class NetworkManager: NSObject {
    ...
    private let monitorQueue = DispatchQueue(label: "com.musicjam.network.monitor")
    ...
    //    openssl s_client -connect api.musicjam.app:443 | openssl x509 -pubkey -noout | openssl pkey -pubin -outform der | openssl dgst -sha256 -binary | openssl enc -base64
    //
