...
//  MusicJam
//
//  Main Tab Navigation - Find Musicians, Make Music
//
...
struct MainTabView: View {
    ...
    private var isAdminUser: Bool {
        ...
        let adminEmails = ["perezkevin640@gmail.com", "admin@musicjam.app"]
...
struct TabBarButton: View {
    ...
    private var accessibilityHint: String {
        switch title {
        case "Discover":
            return "Browse musicians in your area"
        case "Jams":
            return "View your jam matches"
        case "Messages":
            return "Read and send messages"
        case "Saved":
            return "View saved musicians"
        case "Profile":
            return "Edit your music profile and settings"
        case "Admin":
