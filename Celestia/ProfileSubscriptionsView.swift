...
struct ProfileSubscriptionsView: View {
    ...
    private let featureCards: [FeatureCardItem] = [
        ...
        FeatureCardItem(
            ...
            description: "Get connected with compatible musicians first. Our algorithm works harder for you!",
            color: .green,
    ...
    private var helpCard: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 0) {
                Button {
                    if let url = URL(string: "mailto:support@musicjam.app") {
                        UIApplication.shared.open(url)
                    }
                } label: {
                    HStack {
                ...
                Button {
                    if let url = URL(string: "https://musicjam.app/faq") {
                        UIApplication.shared.open(url)
                    }
                } label: {
                    HStack {
                ...
                Button {
                    if let url = URL(string: "https://musicjam.app/terms") {
                        UIApplication.shared.open(url)
                    }
                } label: {
                    HStack {
